...
import 'package:jkstore/widgets/order_admin_header.dart';

class OrderAdminTile extends StatelessWidget {

  final DocumentSnapshot order;

  OrderAdminTile(this.order);
                  ...
                  Column(
                    ...
                    children: order.data["products"].map<Widget>((p){
                      return ListTile(
                        ...
                        trailing: Text(p["quantity"].toString(), style: TextStyle(fontSize: 16),),
                      );
                    }).toList(),
                  ),
                  Row(
                    ...
                    children: <Widget>[
                      FlatButton(
                        onPressed: (){
                          // Apaga o pedido relacionados ao usuário
