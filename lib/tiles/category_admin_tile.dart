...
import 'package:jkstore/screens/product_admin_screen.dart';
import 'package:jkstore/widgets/edit_category_dialog.dart';

class CategoryAdminTile extends StatelessWidget {

  final DocumentSnapshot category;

  CategoryAdminTile(this.category);
                      ...
                      return ListTile(
                        ...
                        onTap: (){
                          Navigator.of(context).push(
                            MaterialPageRoute(builder: (context) => ProductAdminScreen(
