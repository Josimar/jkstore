...
class UserBloc extends BlocBase{
  ...
  List<Map<String, dynamic>> _filter(String search){
    List<Map<String, dynamic>> filtered = List.from(_users.values.toList());

    filtered.retainWhere((user){
  ...
  void _subscribeToOrder(String uid){
    // Pega toda vez que é solicitado
  ...
  void _unsubscriptionOrders(String uid){
